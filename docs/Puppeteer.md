...
Перейти в профіль Tudor та протестувати, чи коректно відображаються всі відповідні блоки. Якщо щось не коректно відображається, виправити це на місце. Тобто пройтись по всіх вкладках цієї сторінки і поправляти для корекції всі баги та невідповідності з дизайном.
працюй не зупиняючись