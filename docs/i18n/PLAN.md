...
- [ ] Оновити onboarding-інструкції (відкладено до завершення етапів 4-6)

**Результати перевірки (2026-01-13)**
- ✅ `npm run i18n:check` проходить успішно
...
- ⚠️ 543 unused keys в uk.json (44 placeholders + 16 risky + 483 safe для ручного аудиту)
