...
- [x] Виправлено структуру `staff.reports.category` (плоскі → вкладені)
- [x] Синхронізовано en.json з uk.json: додано 218+ ключів, видалено 31 зайвий
- [x] Додано всі відсутні template placeholder ключі з `${}` для 15+ доменів
- [x] Виправлено дублікати ключів в uk.json та en.json

**Результати перевірки**
- ✅ `pnpm i18n:check` проходить успішно
- ✅ 0 відсутніх ключів в en.json
- ✅ 0 зайвих ключів в en.json
- ⚠️ 11 порожніх значень (template placeholders — норма)
- ⚠️ 495 unused keys в uk.json (потребують ручного аудиту)

### 🔄 В процесі

**Етап 3: Доменні неймспейси та очистка історичних боргів**
- [ ] Провести повний аудит 495 unused keys
- [ ] Видалити legacy ключі (3 шт.)
- [ ] Переглянути 432 domain-specific ключі
- [ ] Оновити onboarding-інструкції

### 📋 Заплановано

**Етап 4: Інструмент «Missing translations»**
- [ ] Backend endpoint `/i18n/translations/missing/{locale}/`
- [ ] Frontend admin UI для перегляду відсутніх перекладів

**Етап 5: ESLint/AST правило**
- [ ] Власне правило проти хардкоджених рядків

**Етап 6: Авто-звітність**
- [ ] Щотижневий cron-job з репортом у Slack
