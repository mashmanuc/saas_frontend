...
| C-1.4 | Чеклист міграції для кожного модуля | ⬜ | — | |
...
|---------|---------|-------|------|
| Сирих `<button>` в модулях | 856 | 856 | < 50 |
| Сирих `<textarea>` | 20+ | 20+ | 0 |
| Кастомних overlay-модалок | 63 | 63 | 0 |
| Файлів токенів | 5 | 5 | 1 |
| Хардкоджених кольорів | ~30 | ~30 | 0 |
| Build warnings | ? | ? | 0 |
