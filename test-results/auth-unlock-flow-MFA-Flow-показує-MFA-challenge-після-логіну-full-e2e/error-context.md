...
- generic [active] [ref=e1]:
    ...
    - generic [ref=e6]:
      ...
      - generic [ref=e10]:
        - generic [ref=e11]:
          ...
          - textbox "Email *" [ref=e14]: mfa-user@example.com
        - generic [ref=e15]:
          - generic [ref=e16]: Пароль *
          - textbox "Пароль *" [ref=e18]: password
  ...
  - generic [ref=e26]:
    ...
    - paragraph [ref=e34]: "Сталася помилка на сервері. Спробуй ще раз пізніше. (request_id: 5428e1ee-6bea-4e23-99ee-5bf0d8ecb1d7)"
