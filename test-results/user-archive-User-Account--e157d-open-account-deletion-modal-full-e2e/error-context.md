...
- generic [active] [ref=e1]:
    ...
    - generic [ref=e6]:
      ...
      - generic [ref=e10]:
        - generic [ref=e11]:
          ...
          - textbox "Email *" [ref=e14]: e2e-student@example.com
        - generic [ref=e15]:
          - generic [ref=e16]: Пароль *
          - textbox "Пароль *" [ref=e18]: e2e-student
  ...
  - generic [ref=e26]:
    ...
    - paragraph [ref=e34]: "Сталася помилка на сервері. Спробуй ще раз пізніше. (request_id: 073eb261-c8f4-45d4-b0ec-b09cd9cd5c6a)"
