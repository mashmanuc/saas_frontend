  ...
  - generic [ref=e35]:
    ...
    - main [ref=e66]:
      - generic [ref=e67]:
        ...
        - generic [ref=e74]:
          - generic [ref=e75]:
            - paragraph [ref=e76]: Ваш поточний план
            - paragraph [ref=e77]: FREE
          - button "Керувати підпискою" [ref=e78] [cursor=pointer]:
            - generic [ref=e79]: Керувати підпискою
        - generic [ref=e80]:
          - heading "Часті питання" [level=2] [ref=e81]
          - generic [ref=e82]:
            - group [ref=e83]:
              - generic "Як скасувати підписку?" [ref=e84] [cursor=pointer]
            - group [ref=e85]:
              - generic "Чи можу я змінити план?" [ref=e86] [cursor=pointer]
            - group [ref=e87]:
              - generic "Чи повертаються кошти?" [ref=e88] [cursor=pointer]
  - status [ref=e90]:
    - paragraph [ref=e92]: Завантаження...
```