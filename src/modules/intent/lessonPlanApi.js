...
/**
 * Чернетка від Інтегралика приходить у форматі Г1 (role/goal/planned) — до
 * Г2-г резолвер його ще не міняв. Показуємо її в полях Г2, а на сервер шлемо
 * як є: `set_plan` приймає обидва формати через адаптер. Тут — лише погляд.
 */
