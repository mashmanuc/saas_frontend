...
/**
 * Шаблон плану: п'ять етапів, перший активний.
 *
 * ⚠️ З Г3-кроку-2 панель ним НЕ користується: каркас складає сервер із (тип
 * уроку, мета) — п'ять різних каркасів, один SSOT. Лишається як єдиний
 * запасний варіант, якщо каркас від сервера не приїде, і його тримає тест.
 * Не будувати на ньому нового: розійдеться з бекендом мовчки.
 */
