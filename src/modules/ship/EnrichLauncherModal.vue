<!--
  ...
  ⚠️ Модалка НЕ закривається на `@applied` (2026-08-17, самоаудит Фази 5):
  раніше закривалась — і підсумок «Додано N карток · на сторінках 3–10»,
  який прев'ю малює після застосування, зникав разом із вікном. Тост тут не
  рятує: `ToastContainer` живе у `PageShell`, а дошка його не рендерить —
  на /winterboard/* сповіщення просто нікуди вивести. Тому закриття — лише
  явне (✕ / клік повз / Esc), як і має бути після роботи, яку тьютор
  щойно підтвердив.
-->
<template>
  <div
