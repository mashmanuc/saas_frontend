 ...
 * властивостей (`P18`, `P569`) у картку НЕ малюються.
 *
 * ⚠️ Посилання на сутність — НАША структура `EntityRef`, не формат джерела
 * (інваріант `CLAUDE_RULES.md`, 2026-09-21). Дошка, Replay і фронт її
...
export type WBExportFormat = 'png' | 'pdf' | 'annotated_pdf' | 'pptx'
