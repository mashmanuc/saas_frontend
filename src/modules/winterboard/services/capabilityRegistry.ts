...
export const INTENT_TO_RENDERERS: Record<string, string[]> = {
  ...
  // ── Calculus ───────────────────────────────────────────────────────────────
  show_derivative:    ['calculus'],
  show_integral_area: ['calculus'],
  ...
  // ── 2D Geometry ────────────────────────────────────────────────────────────
  show_2d_shape:          ['geometry_2d'],
  show_angles:            ['geometry_2d'],
  show_height:            ['geometry_2d'],
  show_diagonals:         ['geometry_2d'],
  show_median:            ['geometry_2d'],
  show_bisector:          ['geometry_2d'],
  show_circumscribed_circle: ['geometry_2d'],
  show_vectors_2d:        ['geometry_2d'],
  show_vector_sum:        ['geometry_2d'],
