/**
 * API для домену "Групи / Класи"
 * Виокремлено з @/modules/learning-content/api/learningGroupApi
 *
 * Backend endpoint base: /api/v1/learning-content/learning-groups/
 * (URL залишається тим самим — тільки фронтенд-модуль змінено)
 */
...
export const groupApi = {
  ...
  /** Soft delete: бекенд виставляє is_active=False (не видаляє з БД) */
  async deleteGroup(groupId: string): Promise<void> {
    return apiClient.delete(`${BASE}/learning-groups/${groupId}/`)
  },
