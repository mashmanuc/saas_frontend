...
export const TOPICS = [
  ...
  { value: 'powers',                                       label: 'Степінь та його властивості' },
  ...
  { value: 'rational-irrational-expressions.square-roots', label: 'Квадратні корені' },
  ...
  { value: 'real-numbers.divisibility',                    label: 'Подільність' },
  ...
  { value: 'triangles.solving',                            label: "Розв'язування трикутників" },
