...
const steps: CoachingStep[] = [
  ...
  {
    // 2026-09-23 (FIRST USER GATE, п.1): текст казав «тут ви відмічаєте
    // години занять для ваших учнів» — блок «Позначити вільний час» прибрано
    // з Розкладу 2026-09-22 (учні тих годин не бачать, маркетплейс вимкнено).
    // Тепер крок описує те, що на сторінці справді є.
